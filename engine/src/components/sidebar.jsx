...
import { Home, BatteryCharging, Route, ScrollText, Menu, X } from "lucide-react";
            ...
            >
                ...
                <nav className="p-2 space-y-1">
                    {menuItems.map((item, index) => {
                        ...
                        const isActive = item.other_paths.some(element => location.pathname === element) || location.pathname === item.path;
